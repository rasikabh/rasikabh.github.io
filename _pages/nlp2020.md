...
| Oct 19 | Lexical Semantics, Discuss practice midterm exam                                              |        | Project proposal |
| Oct 26 | **Midterm Exam**                                                                              |        |                |
...
| Dec 21 | Finals slot - unused                                                                          |        | Final paper due |
...
### Final Project
The final project will be done in groups of 3 or 4 students. In the case of *extreme* imbalance, grades for each student in the group will be adjusted based on participation. The final project grade will come from five components: statement of interest (4%), proposal (10%), paper draft (20%), presentation (30%), and final paper (36%). Each student will submit a statement of interest, which is up to a paragraph describing the type of project you would be interested in. I will assign students into groups based on topics, and each group will submit a proposal, which is a few paragraphs describing your idea, the problem you are solving, where you will get data, what NLP you will do, and anything else needed to understand your project.
